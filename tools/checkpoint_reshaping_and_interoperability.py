...
# from build_tokenizer import _SentencePieceBPETokenizer
...
def convert_checkpoint_from_megatron_to_transformers(args):
    ...
    # tokenizer = _SentencePieceBPETokenizer(args.tokenizer_file)
    
    tokenizer = LlamaTokenizer.from_pretrained(args.tokenizer_file)
